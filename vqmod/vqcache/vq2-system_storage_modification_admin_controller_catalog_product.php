...
'facebook/facebookproduct/validateFAEAndProductSync',
$operation,
$error_data);
} catch (Exception $e) {
$this->session->data['error_facebook_sync'] =
($e->getCode() === FacebookGraphAPI::ACCESS_TOKEN_EXCEPTION_CODE)
...
$url .= '&debug_facebook_sync_error=1';
		...
		foreach ($product_images as $product_image) {
			...
			$data['product_images'][] = array(
				...
				'image_alt' => $product_image['image_alt']
			);
		}
