...
var cc =
{
	...
	strings: {
		...
		analyticsDefaultDescription: "We anonymously measure your use of this website to improve user experience.",
		advertisingDefaultDescription: "Adverts will be chosen for you automatically based on your past behaviour and interests.",
		defaultDescription: "Default cookie description.",
		notificationTitle: "Your experience on this site will be improved by allowing cookies",
		notificationTitleImplicit: "We use cookies to ensure full functionality of our website.<br />If you continue without changing your settings, we'll assume that you are happy to receive all cookies on this website.",
	...
	showbanner: function ()
	{
		...
		data = '<div id="cc-notification">' +
			...
			{
				jQuery('#cc-notification h2 span').html(cc.strings.notificationTitleImplicit)/*.append(' <a class="thickbox" href="index.php?route=information/information/info&information_id=3">More Info</a>')*/;
			...
			jQuery('ul.cc-notification-buttons').append('<li id="change-settings"><a class="cc-link" href="#" id="cc-notification-moreinfo">'+cc.strings.seeDetails+'</a></li>');
			if(cc.settings.consenttype == "implicit")
			{
