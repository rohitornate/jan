<!--<div class="panel panel-default">
  <div class="panel-heading">
    ...
    <div class="cart-coupon" style="display:none;">
        ...
        <!--<input type="text" name="code" placeholder="Please enter Prome code" class="form-control">-->
                            <button class="btn-apply" id="button-coupon" data-loading-text="<?php echo $text_loading; ?>">Apply </button>
                        </div>
                    </div>
