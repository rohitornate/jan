...
<div class="panel panel-green1 couponpanel">
		...
		<div id="xoptions-content">
          ...
          <tbody>
			...
			<td class="text-right"><span style="cursor: pointer;"><a data-toggle="modal" data-target="#couponModal" style="background-color:#670067; padding:10px; border-radius:5px; border:1px solid #670067;color:#fff;"><b><?php echo $coupon_apply_text;?></b></a></span></td>
            </tr>
            <?php } ?>
            <?php if($display_vouchers){?>
            <tr>          
