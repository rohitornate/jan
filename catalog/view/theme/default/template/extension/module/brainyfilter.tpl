...
<div class=" bf-panel-wrapper<?php if($isResponsive) : ?> bf-responsive<?php endif; ?> <?php echo $responsivePos; ?> bf-layout-id-<?php echo $layout_id;?>">
    ...
    <div class="boxfilter bf-check-position <?php if ($isHorizontal) : ?>bf-horizontal<?php endif; ?>" style="width: 95%;">
        <div class="boxfilter-heading" style="display:none;height:40px;padding:10px;"><span style="">FILTER BY</span><a class="rightclose" style="float:right" >CLOSE</a><?php if ($isHorizontal) : ?><a class="bf-toggle-filter-arrow"></a><input type="reset" class="bf-buttonclear" onclick="BrainyFilter.reset();" value="<?php echo $reset; ?>" /><?php endif; ?></div>
            ...
            <form class="bf-form 
                ...
                <?php foreach ($filters as $i => $section) : ?>
                        ...
                        <div class="bf-attr-block-cont">
							...
							<div class="bf-price-container box-content bf-attr-filter">
											<div class="bf-cur-symb">
												...
												<button type="button" id="customPriceButton" onclick="BrainyFilter.sendRequest(jQuery(this));BrainyFilter.loadingAnimation();return false;">
														
														Go
													</button>
											</div>
											<div class="bf-price-slider-container bf-slider-with-labels">
												<div class="bf-slider-range ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" data-slider-type="3"><div class="ui-slider-range ui-widget-header ui-corner-all" style="left: 0%; "></div><span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 0%;"></span><span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 100%;"></span><span class="bf-slider-label" style="left: 0%; margin-left: 0px;">$0.00</span><span class="bf-slider-label" style="">$10000.00</span></div>
											</div>
							</div>
                    ...
                    <?php else : ?>
						...
						<?php /*if(($currentPath==72 ||$currentPath==64 ||$currentPath==70 ||$currentPath==59) && ($groupId==4))continue;*/  ?>
						<?php if(($filter_enable==0) && ($groupId==4))continue;  ?>
				...
				<div class="lastbtn " >
	<div class="leftreset " style="padding: 10px; text-align: center;display:none;">
		<a class="" style="cursor:pointer; color:rgba(255,0,0,.85);" onclick="BrainyFilter.reset();">RESET</a>
	</div>
	<div  class="rightclose " style="padding: 10px; text-align: center;display:none;">
		<a class="" >CLOSE</a>
	</div>                
</div>
...
BrainyFilter.min = BrainyFilter.min || <?php echo '0'; ?>;
BrainyFilter.max = BrainyFilter.max || <?php echo $priceMax; ?>;
BrainyFilter.lowerValue = BrainyFilter.lowerValue || <?php echo '0'; ?>; 
    ...
    if (! BrainyFilter.isInitialized) {  
        ...
        def.then(function() {
            if('ontouchend' in document && jQuery.ui) {
                jQuery('head').append('<script src="https://ornate-bc57.kxcdn.com/catalog/view/javascript/jquery.ui.touch-punch.min.js"></script' + '>');
            }
        });
        if (typeof jQuery.fn.slider === 'undefined') {
            jQuery.getScript('https://ornate-bc57.kxcdn.com/catalog/view/javascript/jquery-ui.slider.min.js', function(){
                def.resolve();
                jQuery('head').append('<link rel="stylesheet" href="https://ornate-bc57.kxcdn.com/catalog/view/theme/default/stylesheet/jquery-ui.slider.min.css" type="text/css" />');
                BrainyFilter.init();
            });
        } else {
            def.resolve();
