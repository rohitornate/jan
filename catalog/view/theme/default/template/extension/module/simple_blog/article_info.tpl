<?php echo $header; ?>
  ...
  <div class="header-breadcrumbs hidden-mobile">
    <div class="container fluid">
      <ul class="breadcrumb header-breadcrumbs-links">
...
<?php if(isset($article_info_found)) { ?>
                <article>
                    ...
                    <div class="heading"><?php echo $article_info['article_title']; ?></div>
                    <span class="date"><?php echo $article_date_modified; ?></span>
                     <?php if(isset($featured_found)) { ?>
    						...
    						<?php } ?>
                    <div class="bottom disflex-spbetween">
                        <ul class="social">
                            ...
                            <?php if($image) { ?>
    							<?php if(isset($featured_found)) { ?>
    								<div class="article-image">
    									<img src="<?php echo $image; ?>" alt="<?php echo $article_info['article_title']; ?>" height="500" class="img-responsive" />
    								</div>
    							<?php } else { ?>
                                        			...
                                        			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        				<div class="form-group">
                                                            ...
                                                            <div class="related-article-button">
                                            					  <a href="<?php echo $related_article['article_href']; ?>" class="btn btn-success"><?php echo $button_continue_reading; ?></a>
                                            				</div>
