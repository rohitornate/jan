...
<div class="heading"> <!--heading star  here -->
                    ...
                    <span>Please Fill The Form below to start your return process</span>
                </div> 
				
				<div class="form-group required">
           <p style="color:red">* Please make sure products have tags. Intacts to be eligible for return and refunds.</p>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
		...
		<fieldset>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="bank_name" value="<?php echo $bank_name; ?>" placeholder="Enter Bank Name" id="input-firstname" class="form-control" />
              
            </div>
          </div>
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-firstname">Account Holder Name</label>
            <div class="col-sm-10">
              <input type="text" name="account_name" value="<?php echo $account_name; ?>" placeholder="Enter Account Name" id="input-firstname" class="form-control" />
              
            </div>
          </div>
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-firstname">Bank Account Number</label>
            <div class="col-sm-10">
              <input type="text" name="bank_account" value="<?php echo $bank_account; ?>" placeholder="Enter Bank Number" id="input-firstname" class="form-control" />
              
            </div>
          </div>
		   <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-firstname">Bank Branch</label>
            <div class="col-sm-10">
              <input type="text" name="bank_branch" value="<?php echo $bank_branch; ?>" placeholder="Enter Bank Branch" id="input-firstname" class="form-control" />
              
            </div>
          </div>
		  <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-firstname">Bank Address</label>
            <div class="col-sm-10">
              <input type="text" name="bank_address" value="<?php echo $bank_address; ?>" placeholder="Enter Bank Branch" id="input-firstname" class="form-control" />
              
            </div>
          </div>
		  
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-firstname">IFSC Code</label>
            <div class="col-sm-10">
              <input type="text" name="bank_ifsc" value="<?php echo $bank_ifsc; ?>" placeholder="Enter Bank IFSC" id="input-firstname" class="form-control" />
