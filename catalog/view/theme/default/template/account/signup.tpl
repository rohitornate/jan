    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account" class="xpersonal">
          ...
          <div class="form-group <?php if ($modData['f_name_req'])  echo "required" ; ?>">
          ...
          <div class="form-group <?php if ($modData['l_name_req'])  echo "required" ; ?>">
          ...
          <div class="form-group <?php if ($modData['mob_req'])  echo "required" ; ?>">
          ...
          <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            ...
            <div class="col-sm-10">
              <select <?php if($custom_field['tips']) echo $title.$custom_field['tips'] ."'" ; ?> name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control">
          ...
          <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            ...
            <div class="col-sm-10">
              <div>
                <?php foreach ($custom_field['custom_field_value'] as $custom_field_value) { ?>
                <div class="radio" <?php if($custom_field['tips']) echo $title.$custom_field['tips'] ."'" ; ?>>
                  <?php if (isset($register_custom_field[$custom_field['custom_field_id']]) && $custom_field_value['custom_field_value_id'] == $register_custom_field[$custom_field['custom_field_id']]) { ?>
                  <label>
          ...
          <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            <label class="col-sm-2 control-label"><?php echo $custom_field['name']; ?></label>
            <div class="col-sm-10" <?php if($custom_field['tips']) echo $title.$custom_field['tips'] ."'" ; ?>>
              <div>
                <?php foreach ($custom_field['custom_field_value'] as $custom_field_value) { ?>
                <div class="checkbox">
          ...
          <?php } ?>
          <?php } ?>
          <?php if (($single_box) || ($modData['show_address']))
          { }else{?>
        </fieldset>
        <fieldset id="address" class="xaddress">
          <legend><?php echo $text_your_address; ?></legend>
          <?php } ?>
          <?php if(!$modData['show_address']){?> 
          <?php if ($modData['company_show']) { ?>
          ...
          <?php }?>
          <?php if ($modData['address1_show']) { ?>
          <xdiv sort="a<?php echo $modData['address1_sort']; ?>">
          <div class="form-group <?php if ($modData['address1_req'])  echo "required" ; ?>">
          ...
          <?php }?>
          <?php if ($modData['city_show']) { ?>
          <xdiv sort="a<?php echo $modData['city_sort']; ?>">
          <div class="form-group <?php if ($modData['city_req'])  echo "required" ; ?>">
          ...
          <?php }?>
          <?php if ($modData['pin_show']) { ?>
          <xdiv sort="a<?php echo $modData['pin_sort']; ?>">
          <div class="form-group <?php if ($modData['pin_req'])  echo "required" ; ?>">
          ...
          <?php }?>
          <?php if ($modData['country_show']) { ?>
          <xdiv sort="a<?php echo $modData['country_sort']; ?>">
          <div class="form-group <?php if ($modData['country_req'])  echo "required" ; ?>">
          ...
          <?php }?>
          <?php if ($modData['state_show']) { ?>
          <xdiv sort="a<?php echo $modData['state_sort']; ?>">
          <div class="form-group <?php if ($modData['state_req'])  echo "required" ; ?>">
        ...
        <fieldset class="xpassword">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="password" name="password" value="<?php echo $password; ?>" <?php echo $title_password;?> placeholder="<?php echo $entry_password; ?>" id="input-password" class="form-control" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="password" name="confirm" value="<?php echo $confirm; ?>" <?php echo $title_confirm;?> placeholder="<?php echo $entry_confirm; ?>" id="input-confirm" class="form-control" />
          ...
          <?php }?>
          <?php if ((!$single_box && $modData['subsribe_show'])) { ?>
        </fieldset>
        ...
        <fieldset>
          ...
          <xdiv sort="a<?php echo $modData['subscribe_sort']; ?>">
          <div class="form-group">
...
<?php foreach ($custom_fields as $custom_field){?>
	<?php if(($custom_field['type']=='text') && $custom_field['mask']){?>
		$("input[name='custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]']").mask("<?php echo $custom_field['mask']; ?>");
	<?php }?>
<?php }?>
 });
 </script> 
...
//--></script> 
<script type="text/javascript"><!--
$('<?php (($modData['country_show'])?'select':'input');?>[name=\'country_id\']').on('change', function() {
	$.ajax({
...
$('<?php (($modData['country_show'])?'select':'input');?>[name=\'country_id\']').trigger('change');
//--></script>
<?php echo $footer; ?>