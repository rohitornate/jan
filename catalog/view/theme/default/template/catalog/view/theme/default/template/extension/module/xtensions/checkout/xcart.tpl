...
<div class="panel panel-green1 xcart">
...
<div class="media">
  ...
  <div class="media-body">
    ...
    <a class="optionLink pointer text-right" onclick="toggleOptions('xoptions<?php echo $countOptions; ?>-<?php echo $section; ?>')"><i class="fa fa-info-circle" aria-hidden="true"></i></a>
  	...
  	<div class="text-left width50"><span class="is_amount text-muted"><?php echo $product['quantity']; ?> X <?php echo $product['price']; ?></span></div><div class="text-right width50"><span class="is_total"><?php echo $product['total']; ?></span></div>
   <div class="clearfix"></div>   
