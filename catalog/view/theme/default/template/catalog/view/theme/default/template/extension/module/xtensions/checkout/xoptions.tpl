...
<div id="xoptions-content">
  ...
  <div id="comment-panel" class="form-group cvc-panel">
  	<div class="row">
		<span class="col-md-6"><?php echo $comment_text;?></span>
		<div class="col-md-6 text-right"><a data-toggle="modal" data-target="#commentModal"><i class="fa fa-comment" aria-hidden="true"></i>&nbsp;<?php echo $comment_apply_text1;?></a></div>
	</div>           
</div>
<?php } ?>
</div>
