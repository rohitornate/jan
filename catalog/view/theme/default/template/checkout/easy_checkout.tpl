<?php echo $header; ?>
	<img src="image/data/ga.png" onload="<?php if ($ga_tracking_type == 0) { echo "ga('send', 'pageview', '/checkout');";} else{echo "_gaq.push(['_trackPageview','/checkout']);"; } ?>">
...
<!--				  <div class="form-group" >
				  ...
				  <div class="form-group required col-md-6">
				    ...
				    <input type="text" name="lastname" value="<?php if (isset($lastname)) echo $lastname;?>" placeholder="<?php echo str_replace(':','',$entry_lastname); ?>" id="input-payment-lastname" class="form-control" <?php if (isset($customer_id)) {?> <?php }?>/>
				  </div>
				  <div class="form-group required col-md-12">
				    <label class="control-label" for="input-payment-email"><?php echo $entry_email; ?></label>
				    <input type="text" name="email" value="<?php if (isset($email)) echo $email;?>" placeholder="<?php echo str_replace(':','',$entry_email); ?>" id="input-payment-email" class="form-control"/>
				  </div>
				  <div class="form-group required  col-md-12">
				    <label class="control-label" for="input-payment-telephone"><?php echo $entry_telephone; ?></label>
				    <input type="text" name="telephone" value="<?php if (isset($telephone)) echo $telephone;?>" placeholder="<?php echo str_replace(':','',$entry_telephone); ?>" id="input-payment-telephone" class="form-control" required="required" />
				  </div>
				  <?php //if (!$checkout_hide_fax) {?>
                                        <div class="form-group col-md-6" style="display: none;" >
				    <label class="control-label" for="input-payment-fax"><?php echo $entry_fax; ?></label>
				    <input type="text" name="fax" value="<?php if (isset($fax)) echo $fax;?>" placeholder="<?php echo str_replace(':','',$entry_fax); ?>" id="input-payment-fax" class="form-control" <?php if (isset($customer_id)) {?> <?php }?>/>
				  </div>
				  <?php //}?>
...
$('body').delegate('[name=\'payment_method\']','click', function() 
{
	...
	var email=$('.checkout_form input[name=\'email\']').val();
	if(email==''){
		alert('Please provide email address');
		return false;
	}
	var telephone=$('.checkout_form input[name=\'telephone\']').val();
	if(telephone==''){
