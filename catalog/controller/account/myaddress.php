...
class ControllerAccountMyAddress extends Controller {
	...
	protected function getList() {
		...
		$this->template = 'account/address_list';
	...
	protected function getForm() {
		...
		} else if(isset($this->session->data['shipping_postcode'])) {
		...
		$this->template = 'account/myaddress_form';
	...
	protected function validateForm() {
		...
		foreach ($custom_fields as $custom_field) {
			if($custom_field['location'] == 'address'){
				if (($custom_field['type'] == 'text') && !empty($custom_field['validation'])  && !filter_var($this->request->post['custom_field'][$custom_field['custom_field_id']], FILTER_VALIDATE_REGEXP, array('options' => array('regexp' => $custom_field['validation'])))) {
