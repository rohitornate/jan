...
class ControllerExtensionModuleXtensionsCheckoutXHeader extends Controller {
	...
	public function index() {
		...
		$analytics = $this->model_extension_extension->getExtensions('analytics');
				...
				$this->data['ga_tracking_type'] = $this->config->get('config_ga_tracking_type');
		$this->data['ga_exclude_admin'] = $this->config->get('config_ga_exclude_admin');
		$this->data['ua_tracking'] = $this->config->get('config_ua_tracking');
		$this->data['ga_domain'] = $this->config->get('config_ga_domain');
		$this->data['ga_remarketing'] = $this->config->get('config_ga_remarketing');
		$this->data['ga_cookie'] = $this->config->get('config_ga_cookie');
		$this->data['user_logged'] = $this->user->isLogged();
