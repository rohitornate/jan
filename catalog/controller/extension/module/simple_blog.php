            ...
            if($setting['status']) {
    			...
    			foreach($results as $result) {
    				...
    				if($result['featured_image']) {
    					$image = $this->model_tool_image->resize($result['featured_image'], 110, 56);
    				} else if($result['image']) {
    					$image = $this->model_tool_image->resize($result['image'], 110, 56);
    				} else {
    					$image = $this->model_tool_image->resize('no_image.jpg', 110, 56);
    				}
