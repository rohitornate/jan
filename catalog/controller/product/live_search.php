	...
	public function index() {
		...
		if(!$error){
			if (isset($this->request->get['filter_name'])) {
				...
				//$results = $this->model_catalog_product->getProductsLiveSearch1($filter_data);
				...
				foreach ($results as $result) {
					...
					//	'name' => utf8_substr(strip_tags(html_entity_decode($result['tag_name'], ENT_QUOTES, 'UTF-8')), 0, $title_length) . '..',
						...
						//'url'        => $this->url->link('product/search', 'search=' . $result['tag_name'])
					);
