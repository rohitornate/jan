...
class ModelExtensionModuleXtensionsCustomField extends Model {	
	...
	public function getCustomFieldDescriptions($custom_field_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "custom_field_description cfd LEFT JOIN " . DB_PREFIX . "xcustom_field_description xcfd ON (cfd.custom_field_id = xcfd.custom_field_id AND cfd.language_id = xcfd.language_id) WHERE cfd.custom_field_id = '" . (int)$custom_field_id . "'");
