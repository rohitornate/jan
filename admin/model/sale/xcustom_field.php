...
class ModelSaleXCustomField extends Model {	
	public function addCustomField($data) {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "custom_field` SET type = '" . $this->db->escape($data['type']) . "', value = '" . $this->db->escape($data['value']) . "', validation = '" . $this->db->escape($data['validation']) . "', location = '" . $this->db->escape($data['location']) . "', status = '" . (isset($data['status'])?1:0) . "', list_display = '" . (isset($data['list_display'])?1:0) . "', order_display = '" . (isset($data['order_display'])?1:0) . "', email_display = '" . (isset($data['email_display'])?1:0) . "', invoice = '" . (isset($data['invoice'])?1:0) . "', isnumeric = '" . (isset($data['isnumeric'])?1:0) . "', sort_order = '" . (int)$data['sort_order'] . "', identifier = '" .  $this->db->escape($data['identifier']) . "', mask = '" .  $this->db->escape($data['mask']) . "', minimum = '" . (int)$data['minimum'] . "', maximum = '" .  (int)$data['maximum'] . "'");

		$custom_field_id = $this->db->getLastId();

		foreach ($data['custom_field_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "custom_field_description SET custom_field_id = '" . (int)$custom_field_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', error = '" . $this->db->escape($value['error']) . "', tips = '" . $this->db->escape($value['tips']) . "'");
		}
	...
	public function editCustomField($custom_field_id, $data) {
		$this->db->query("UPDATE `" . DB_PREFIX . "custom_field` SET type = '" . $this->db->escape($data['type']) . "', value = '" . $this->db->escape($data['value']) . "', validation = '" . $this->db->escape($data['validation']) . "', location = '" . $this->db->escape($data['location']) . "', status = '" . (isset($data['status'])?1:0) . "', list_display = '" . (isset($data['list_display'])?1:0) . "', order_display = '" . (isset($data['order_display'])?1:0) . "', email_display = '" . (isset($data['email_display'])?1:0) . "', invoice = '" . (isset($data['invoice'])?1:0) . "', isnumeric = '" . (isset($data['isnumeric'])?1:0) . "', sort_order = '" . (int)$data['sort_order'] . "', identifier = '" .  $this->db->escape($data['identifier']) . "', mask = '" .  $this->db->escape($data['mask']) . "', minimum = '" . (int)$data['minimum'] . "', maximum = '" .  (int)$data['maximum'] . "' WHERE custom_field_id = '" . (int)$custom_field_id . "'");
