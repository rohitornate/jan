        ...
        <div class="panel-heading">
            ...
            <div class="storeSwitcherWidget">
            	<div class="form-group">
                	<button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-pushpin"></span>&nbsp;<?php echo $store['name']; if($store['store_id'] == 0) echo $text_default; ?>&nbsp;<span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
                ...
                <input type="hidden" name="giftteaser_status" value="1" /> 
                    <div class="tabbable">
                        <div class="tab-navigation">
	                        ...
	                        <li class="active"><a href="#tab_settings" data-toggle="tab"><i class="fa fa-cogs"></i>&nbsp;Main Settings</a></li>
                            <li><a href="#tab_widget" data-toggle="tab"><i class="fa fa-bookmark" aria-hidden="true"></i>&nbsp;Layout</a></li>
                            <li><a href="#tab_gift" data-toggle="tab"><i class="fa fa-gift"></i>&nbsp;Gifts</a></li>
