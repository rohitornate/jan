...
<div class="page-header">
   ...
   <div class="panel panel-default">
      <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-pencil"></i> Edit: <?php echo $heading_title; ?></h3></div>   
...
<tr><td><ul><li>Images must be named p1.png to p7.png in folder catalog/view/xtensions/image/payment/</li></ul></td></tr>
...
$('select[name=\'country_id\']').bind('change', function() {
  $.ajax({
    url: 'index.php?route=extension/module/signup/country&token=<?php echo $token; ?>&country_id=' + this.value,
    dataType: 'json',
