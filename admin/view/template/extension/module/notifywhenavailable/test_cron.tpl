<table class="table testCron" style="margin-bottom:0px;">
	...
	<tr>
		...
		<tr><td><?php  echo $cron_folder;?></td>
			<td><strong><p class="<?php echo $folder_permission ?>"><?php echo (!empty($folder_permission) && $folder_permission == "Writable") ? '<span style="color:#4CC417">'.$folder_permission.'</span>' : '<span style="color:#F70D1A">'.$folder_permission.'</span>'; ?></strong></td>
		</tr>
	<tr>
