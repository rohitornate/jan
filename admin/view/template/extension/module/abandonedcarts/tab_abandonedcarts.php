    ...
    <div class="modal-dialog modal-lg" style="width: 90% !important;margin: 20px auto;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="sendReminderModalLabel"><?php echo $text_send_reminder; ?></h4>
            </div>
            
            <div class="modal-body" style="overflow:auto;" id="sendReminderModalBody"></div>
            
            <div class="modal-footer">
		        <button class="btn" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i> <?php echo $text_close; ?></button>
		        <button class="btn btn-primary" data-loading-text="Sending..." id="sendMail"><i class="fa fa-envelope-square"></i> <?php echo $text_send_mail; ?></button>
            </div>
        </div>
     </div>
</div>