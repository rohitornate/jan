...
<div id="content">
  ...
  <div class="container-fluid">
        ...
        <!--    <li><a href="#tab-reward" data-toggle="tab"><?php echo $tab_reward; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <tr id="special-row0" style="display:none;">
   ...
   <td class="text-right" style="display:none;"><input type="text" name="product_special[0][priority]" style="display:none;" value="" placeholder="<?php echo $entry_priority; ?>" class="form-control" /></td>
    ...
    <td class="text-left" style="width: 20%;" style="display:none;"><div class="input-group date" style="display:none;"><input type="text" readonly name="product_special[0][date_start]" value="" placeholder="<?php echo $entry_date_start; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>
   ...
   <td class="text-right" style="display:none;"><input readonly type="text" name="product_special[0][priority]" style="display:none;" value="" placeholder="<?php echo $entry_priority; ?>" class="form-control" /></td>
    ...
    <td class="text-left" style="width: 20%;" style="display:none;"><div class="input-group date" style="display:none;"><input readonly type="text" name="product_special[0][date_start]" value="" placeholder="<?php echo $entry_date_start; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>
	<td class="text-left" style="width: 20%;" style="display:none;"><div class="input-group date" style="display:none;"><input readonly type="text" name="product_special[0][date_end]" value="" placeholder="<?php echo $entry_date_end; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>
	</tr>
