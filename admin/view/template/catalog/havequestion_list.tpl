            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'id') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php echo $column_question; ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $question['email']; ?></td>
                  <td class="text-right"><?php echo $question['question']; ?></td>
