            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'r.city') { ?>
					...
					<td class="text-center"><?php echo 'Sort Order'; ?></td>
              ...
              <tbody>
				...
				<td class="text-center"><?php if ($review['image']) { ?>
				  ...
				  <td class="text-center" style="width:25%;"><?php echo $review['text']; ?></td>
				   <td class="text-right"><?php echo $review['sort_order']; ?></td>
