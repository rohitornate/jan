...
class ControllerSaleXCustomField extends Controller {
	...
	protected function getForm() {
		...
		$this->data['breadcrumbs'][] = array(
			...
			$fields = array('type','value','location','status','sort_order','minimum','maximum','mask','identifier','isnumeric','email_display','order_display','list_display','invoice','validation');
