...
class ControllerExtensionFeedStoreya extends Controller {
	...
	public function index() {
		...
		$this->load->language('extension/feed/storeya');
 		...
 		if (isset($this->error['warning'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/feed/storeya', 'token=' . $this->session->data['token'], 'SSL'),
		...
		$data['action'] = $this->url->link('extension/feed/storeya', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/feed/storeya.tpl', $data));
	...
	protected function validate() {
		...
		if (!$this->user->hasPermission('modify', 'extension/feed/storeya')) {
