(function($) {
    ...
    let $deactivateForm  = jQuery('#facebook-feed-deactivateForm');
    ...
    let deactivateFormSubmitted = localStorage.getItem('facebook-feed-deactivateFormSubmitted');
    ...
    function submitForm(deactivate_options, id) {
        ...
        data.push({name: 'action', value: 'facebook-feed-deactivate'});
        ...
        if (!deactivateFormSubmitted) {
            localStorage.setItem('facebook-feed-deactivateFormSubmitted', true);
            deactivateFormSubmitted = true;

            jQuery.post('./controller/extension/module/elfsight_facebook_feed.php', jQuery.param(data)).then(function(result) {
