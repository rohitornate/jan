...
class ControllerExtensionModuleXtensionsCustomField extends Controller {
	...
	protected function getForm() {
		...
		$this->data['breadcrumbs'][] = array(
			...
			$fields = array('type','value','location','status','xsort_order','minimum','maximum','mask','identifier','isnumeric','email_display','order_display','list_display','invoice','validation');
