...
class ControllerExtensionModuleWhatsApp extends Controller {
	...
	public function __construct($registry){
		...
		$this->extensionLink = $this->url->link($this->config->get($module.'extensionLink'), 'store_id='.$this->request->post['store_id'] .$this->config->get($module.'extensionLink_type') . '&token=' . $this->session->data['token'], 'SSL');
