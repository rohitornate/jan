...
class ControllerExtensionDashboardAbandonedCarts extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/dashboard/abandonedcarts', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/dashboard/abandonedcarts', 'token=' . $this->session->data['token'], true);
	...
	public function dashboard() {
		...
		$data['link'] = $this->url->link('extension/module/abandonedcarts', 'token=' . $this->session->data['token'], true);
